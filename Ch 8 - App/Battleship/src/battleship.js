    ...
    fire: function(guess){
        for (var i = 0; i < this.numShips; i++) {
            ...
            if (ship.hits[index] === "hit"){
                view.displayMessage("Oops! You've already hit that location.");
                return true;
            } else if(index >= 0)
            {
                ship.hits[index] = "hit";
        ...
        view.displayMessage("You missed. Neeners.");
        return false;
    },
...
function handleKeyPress(e){
    ...
    if (e.keyCode === 13){
        ...
        // return false so that the form doesn't do anything else, like trying to submit itself.
        return false;
    }
}
